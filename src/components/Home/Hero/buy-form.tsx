    ...
    <div className="max-w-md mx-auto p-4">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          ...
          <button style={{ backgroundColor: '#13db7a', border: '2px solid #13db7a' }} className="text-darkmode font-medium text-18 w-full rounded-lg py-3 flex items-center justify-center gap-2 hover:text-primary hover:bg-transparent">
            ENTER THE LAB
            <span>
              <Icon icon="mdi:discord" width={24} height={24} style={{ color: '#13db7a' }} />
            </span>
          </button>
      </form>
    </div>
