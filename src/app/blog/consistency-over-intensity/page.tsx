...
export default function ConsistencyOverIntensityBlog() {
  ...
  <article className="max-w-2xl w-full bg-[#181818] rounded-xl shadow-lg p-8 text-white text-center">
          ...
          <p className="text-base mb-6 text-gray-300 text-left">
            Consistency doesn’t happen by accident. It’s built through intentional practices:<br /><br />
            <strong>Start small, stay consistent.</strong> Set a modest daily or weekly trading routine and stick to it. For beginners, that could be a 30‑minute pre‑market prep and journaling session every weekday. Only after you’ve kept that routine for a few weeks should you consider adding more complexity or size. Trying to “get rich or die trying” just leads to burnout and erratic performance.<br /><br />
            <strong>Capture small wins.</strong> As the base‑hit approach suggests, define achievable profit targets and stops for each trade. Consistent small gains reduce emotional swings and let you build confidence. Over time, compounding takes care of the rest.<br /><br />
            <strong>Journal your trades.</strong> Record what you planned, what you did, and how you felt. Many successful traders use journaling to identify patterns in their best and worst trades. Without this feedback loop, you risk repeating mistakes or failing to see what’s working.<br /><br />
            <strong>Review your process weekly.</strong> Set aside a fixed time to review your trades, not just your equity curve. Ask yourself: Which trades followed the plan? Which didn’t? Were the trades that broke rules winners or losers? This practice keeps you focused on process and helps you refine your strategy with data, not emotions.<br /><br />
            <strong>Protect your energy.</strong> Sustainable consistency requires rest and balance. High‑intensity lifestyles glamorized on social media often mask burnout. Incorporate breaks, exercise, and time away from the screen so you can approach markets with a clear head.
          </p>
          <h2 className="text-2xl font-semibold mb-4 text-[#13db7a] text-left">
